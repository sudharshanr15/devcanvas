                ...
                <div class="">
                  <div class="mt-3 sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div class="w-full my-3">
                      <label for="product_name" class="block text-sm/6 font-medium text-gray-900">Project Name</label>
                      <div class="relative mt-2 rounded-md shadow-sm">
                        <input type="text" name="name" required id="product_name" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" placeholder="Enter your project name">
                      </div>
                    </div>
                  </div>
                </div>
